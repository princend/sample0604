...
@NgModule({
    imports: [CommonModule,BrowserAnimationsModule,FormsModule,ToolbarModule,DataListModule,DataTableModule,SharedModule,LocationDialogModule,OrderListModule,DialogModule],
