...
@Component({
  ...
  templateUrl: 'master-detail-demo04.component.html'
})

export class MasterDetailDemoComponent04 implements OnInit,DoCheck{

  @ViewChild('md') masterDetail: MasterDetailComponent04;
  constructor() { }
